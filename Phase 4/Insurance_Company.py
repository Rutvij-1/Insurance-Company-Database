    ...
    try:
        ...
        with con.cursor() as cur:
            while(1):
                ...
                print("25. Get all Customers of given status")
                print("26. Get all Policies bought by given customer")
                print("27. Get inforfmation of all Dependents of a Customer")
                print("28. Get inforfmation of all Dependents of an Employee")
                print(
                    "29. Get inforfmation of all Third Party Administrators in a given city")
                print("30. Get inforfmation of all Policies in a given list")
                print("31. Get inforfmation of all Customers with status in a given list and who have bought policies of a type in a given list")
                print(
                    "32. Get inforfmation of all Policies with their premium in a given range")
                print("33. Get inforfmation of all Customers of a given age")
                print("34. Get total claim value of policy types of a given list")
                print("35. Get Maximum claim value of a given policy type")
                print("36. Get Minimum claim value of a given policy type")
                print("37. Get Average claim value of a given policy type")
                print(
                    "38. Get inforfmation of all Customers with partial/complete match to given name")
                print(
                    "39. Get inforfmation of all Employees with partial/complete match to given name")
                print(
                    "40. Get inforfmation of all Third Party Administrators with partial/complete match to given name")
                print(
                    "41. Generate reports of all claimed policies of a given list of policy types")
                print("42. Generate reports of all policies bought by a given Customer")
                print("0. Logout")
